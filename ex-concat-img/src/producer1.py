...
target_name = 'img1.jpg'
logfile = filepath + 'producer1.csv'
    ...
    def on_interest(int_name, _int_param, _app_param):
        ...
        if seg_no < seg_cnt:
            ...
            if time_q.full():
                ...
                timestamps.append((t0, 'producer1 d-out', Name.to_str(target_name), n0))
                while not time_q.empty():
                    n, t = time_q.get()
                    # timestamps.append([n, t-t0])
                    timestamps.append((t, 'producer1 d-out', Name.to_str(target_name), n))
